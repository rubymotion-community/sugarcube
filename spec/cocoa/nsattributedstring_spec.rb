describe 'NSAttributeString' do
  ...
  describe 'NSString attribute string methods' do
    ...
    it 'should have #bold' do
      ...
      subject.attributesAtIndex(0, effectiveRange:nil).should == {NSFontAttributeName => :bold.uifont}
    end

    it 'should have #italic' do
      subject = 'test'.italic
      subject.should.be.kind_of(NSAttributedString)
      subject.attributesAtIndex(0, effectiveRange:nil).should == {NSFontAttributeName => :italic.uifont}
    end

    it 'should have #monospace' do
      subject = 'test'.monospace
      subject.should.be.kind_of(NSAttributedString)
      subject.attributesAtIndex(0, effectiveRange:nil).should == {NSFontAttributeName => :monospace.uifont}
    end
    ...
    it 'should be chainable' do
      ...
      subject.should.be.kind_of(NSAttributedString)
      subject.attributesAtIndex(0, effectiveRange:nil).should == {NSFontAttributeName => :bold.uifont, NSUnderlineStyleAttributeName => NSUnderlineStyleSingle}
    end
